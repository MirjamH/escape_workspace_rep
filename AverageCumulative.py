...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  4 14:15:32 2019
...
TEST columns:
    ...
    LAST PART ONLY WORKS IF YOU FIRST RUN PelletSurvival AND THEN THIS SCRIPT!!!
"""
...
Loom.loc['SEM'] = Loom.std()/np.sqrt(11)
...
T_Shock.loc['SEM'] = T_Shock.std()/np.sqrt(16)
...
T_Loom.loc['SEM'] = T_Loom.std()/np.sqrt(19)
...
Tone.loc['SEM'] = Tone.std()/np.sqrt(16)
...
T_Loom_filtered.loc['SEM'] = T_Loom_filtered.std()/np.sqrt(13)
...
ax = sns.lineplot(x='sec', y='average', data =T_Loom_fil_tr_num, color = 'blue').set_title('Mean cumulative distance +/- SEM')#T-Shock
...
fig, ax = plt.subplots()
ax2 = ax.twinx()
sns.lineplot(x ='second', y='T_Loom',ax = ax, data = survival, color="blue").set_ylabel('fraction of animals WITHOUT pellet')
sns.lineplot(x='sec', y='average', data =T_Loom_fil_tr_num, color = 'blue', ax =ax2).set_ylabel('cumulative distance traveled')
plt.fill_between(T_Loom_fil_tr_num['sec'],T_Loom_fil_tr_num['lower_bound'] , T_Loom_fil_tr_num['upper_bound'], color ='blue',alpha=.3)
ax.set_title('T_Loom: average distance and pellet survival')
ax2.set_ylim([0, 3200])
ax.set_ylim([0, 1])
#%%
fig, ax = plt.subplots()
ax2 = ax.twinx()
sns.lineplot(x ='second', y='T_Shock',ax = ax, data = survival, color="red").set_ylabel('fraction of animals WITHOUT pellet')
sns.lineplot(x='sec', y='average', data =T_Shock_tr_num, color = 'red').set_ylabel('cumulative distance traveled')
plt.fill_between(T_Shock_tr_num['sec'],T_Shock_tr_num['lower_bound'] , T_Shock_tr_num['upper_bound'], color = 'red', alpha=.3)
ax.set_title('T_Shock: average distance and pellet survival')
ax2.set_ylim([0, 32000])
ax.set_ylim([0, 1])
#%%
fig, ax = plt.subplots()
ax2 = ax.twinx()
sns.lineplot(x ='second', y='Tone',ax = ax, data = survival, color="yellow").set_ylabel('fraction of animals WITHOUT pellet')
sns.lineplot(x='sec', y='average', data =Tone_tr_num, color = 'yellow').set_ylabel('cumulative distance traveled')
plt.fill_between(Tone_tr_num['sec'],Tone_tr_num['lower_bound'] , Tone_tr_num['upper_bound'], color='yellow',alpha=.3)
ax.set_title('Tone: average distance and pellet survival')
ax2.set_ylim([0, 32000])
ax.set_ylim([0, 1])
#%%
fig, ax = plt.subplots()
ax2 = ax.twinx()
sns.lineplot(x ='second', y='Loom',ax = ax, data = survival, color="green").set_ylabel('fraction of animals WITHOUT pellet')
sns.lineplot(x='sec', y='average', data =Loom_tr_num, color = 'green').set_ylabel('cumulative distance traveled')
plt.fill_between(Loom_tr_num['sec'],Loom_tr_num['lower_bound'] , Loom_tr_num['upper_bound'], color = 'green',alpha=.3)
ax.set_title('Loom: average distance and pellet survival')
ax2.set_ylim([0, 32000])
ax.set_ylim([0, 1])
