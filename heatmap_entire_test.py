...
ax = sns.heatmap(binned_no_shelter, vmax =30)
ax.get_ylim()
...
df_L_noshel = df_L.iloc[100:,:]
ax = sns.heatmap(df_L_noshel.T, vmax =180)
ax.get_ylim()
#%%

df_TL_noshel = df_TL.iloc[100:140,:]
ax = sns.heatmap(df_TL_noshel, vmax =180)
ax.get_ylim()

#%%
df_TS_noshel = df_TS.iloc[100:140,:]
ax = sns.heatmap(df_TS_noshel, vmax =180)
ax.get_ylim()

#%%

df_T_noshel = df_T.iloc[100:140,:]
ax = sns.heatmap(df_T_noshel, vmax =180)
ax.get_ylim()
