...
plt.hist(animal_t_loom, bins=16, color="orange", alpha =0.5)
plt.hist(animal_tone, bins=16, color="violet", alpha =0.5)
plt.hist(animal_t_shock, bins=16, color="blue", alpha =0.5)
plt.hist(animal_loom, bins=16, color="green", alpha =0.5)
...
plt.hist([animal_t_shock,animal_tone,animal_t_loom, animal_loom], bins=9,label=['T_Shock', 'Tone', 'T_Loom','Loom'])
plt.legend(loc='upper right')
plt.xlim(right=4.5) 
plt.title('number of animals with 0, 1, 2, 3, or 4 bouts total')
