...
def ShelterTime(file):
    ...
    if file_names == '.DS_Store':
        ...
        dataset = pd.read_csv(path_name +'/' + file_names +'/' + 'test.csv', usecols = [8,9])
...
shelter.loc['MH35_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH36_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH37_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH38_scanning','took_pellet'] = '0 < 1 minute'

shelter.loc['MH40_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH42_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH44_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH50_scanning','took_pellet'] ='0 < 1 minute'
shelter.loc['MH51_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH54_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH57_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH58_scanning','took_pellet'] = '0 < 1 minute'

shelter.loc['MH62_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH63_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH64_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH66_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH67_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH70_scanning','took_pellet'] ='0 < 1 minute'
shelter.loc['MH71_scanning','took_pellet'] ='0 < 1 minute'
shelter.loc['MH72_scanning','took_pellet'] ='0 < 1 minute'
shelter.loc['MH75_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH76_scanning','took_pellet'] = '0 < 1 minute'

shelter.loc['MH81_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH82_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH84_scanning','took_pellet'] = '0 < 1 minute'

shelter.loc['MH92_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH93_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH96_scanning','took_pellet'] = '0 < 1 minute'
shelter.loc['MH98_scanning','took_pellet'] = '0 < 1 minute'

shelter.loc['MH101_scanning','took_pellet'] = '0 < 1 minute'


#%%
shelter.loc['MH48_scanning','took_pellet'] = '1 < 2 minute'
shelter.loc['MH56_scanning','took_pellet'] = '1 < 2 minute'
shelter.loc['MH77_scanning','took_pellet'] = '1 < 2 minute'
shelter.loc['MH85_scanning','took_pellet'] = '1 < 2 minute'
shelter.loc['MH86_scanning','took_pellet'] = '1 < 2 minute'
shelter.loc['MH88_scanning','took_pellet'] = '1 < 2 minute'
shelter.loc['MH90_scanning','took_pellet'] = '1 < 2 minute'

#%%
shelter.loc['MH43_scanning','took_pellet'] = '2 < 3 minute'
shelter.loc['MH47_scanning','took_pellet'] = '2 < 3 minute'
shelter.loc['MH52_scanning','took_pellet'] = '2 < 3 minute'
shelter.loc['MH55_scanning','took_pellet'] = '2 < 3 minute'
shelter.loc['MH60_scanning','took_pellet'] = '2 < 3 minute'
shelter.loc['MH68_scanning','took_pellet'] = '2 < 3 minute'
shelter.loc['MH69_scanning','took_pellet'] = '2 < 3 minute'
shelter.loc['MH73_scanning','took_pellet'] = '2 < 3 minute'
shelter.loc['MH79_scanning','took_pellet'] = '2 < 3 minute'
shelter.loc['MH80_scanning','took_pellet'] = '2 < 3 minute'
#%%
shelter.loc['MH39_scanning','took_pellet'] = '3 < 6 minute'
shelter.loc['MH49_scanning','took_pellet'] = '3 < 6 minute'
shelter.loc['MH60_scanning','took_pellet'] = '3 < 6 minute'

shelter.loc['MH53_scanning','took_pellet'] = '3 < 6 minute'
shelter.loc['MH78_scanning','took_pellet'] = '3 < 6 minute'

shelter.loc['MH74_scanning','took_pellet'] = '3 < 6 minute'
shelter.loc['MH97_scanning','took_pellet'] = '3 < 6 minute'
...
ax.set_title('Time spent scanning (5 min)')
