...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov  6 14:20:05 2019
...
#%%
df_beh = pd.read_csv('/Users/mirjamheinemans/Desktop/Annotator python tryout/beh_xpos_MH49.csv',delimiter=',', low_memory=False, index_col=0)        
...
export_csv = test.to_csv (path+'/analysis files/MH046/test.csv', header=True)
...
export_csv = test.to_csv (path+'/analysis files/MH047/test.csv', header=True)
...
export_csv = test.to_csv (path+'/analysis files/MH048/test.csv', header=True)
...
export_csv = test.to_csv (path+'/analysis files/MH049/test.csv', header=True)
...
export_csv = test.to_csv (path+'/analysis files/MH051/test.csv', header=True)
...
export_csv = test.to_csv (path+'/_T_Shock/MH080/test.csv', header=True)
